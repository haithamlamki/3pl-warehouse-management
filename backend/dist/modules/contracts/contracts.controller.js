...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create contract from template' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Contract created' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Sign contract' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Contract signed' }),
